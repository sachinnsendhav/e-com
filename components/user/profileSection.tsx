...
console.log("showBlock",showBlock, "setShowBlock",setShowBlock)
    return (
        <div style={{ margin: "1rem", border: "0.0625rem solid #dce0e5", width: "20%" }}>
            <div style={{
                display: "flex",
                alignItems: "center",
                ...
                <div><img src={profileIcon.src} style={{ height: "20px", width: "20px" }} /></div>
                <div><p style={{ padding: "9px" }}>Profile</p></div>
            </div>
            <div style={{
                display: "flex",
                alignItems: "center",
                ...
                <div><img src={addressesIcon.src} style={{ height: "20px", width: "20px" }} /></div>
                <div><p style={{ padding: "9px" }}>Addresses</p></div>
            </div>
            <div style={{
                display: "flex",
                alignItems: "center",
                ...
                <div><img src={orderIcon.src} style={{ height: "20px", width: "20px" }} /></div>
                <div><p style={{ padding: "9px" }}>Order History</p></div>
            </div>
            <div style={{
                display: "flex",
                alignItems: "center",
                ...
                <div><img src={shoppingList.src} style={{ height: "20px", width: "20px" }} /></div>
                <div><p style={{ padding: "9px" }}>Shopping Lists</p></div>
            </div>
        </div>
    )
}
