...
const EditInformationForm = ({data,company, setEditUserData}:any) => {
  ...
  const checkboxesContainerStyles:any = {
    marginTop: "1rem",
    display: "block",
    fontSize: " 0.75rem",
    fontWeight: "700",
    ...
    <div style={formContainerStyles}>
      <form className="form">
              ...
              <li className="list__item list__item--checkbox">
                <span className="checkbox">
                  <input
                    ...
                    id="role2"
                    name="roles[]"
                    value="Buyer With Limit"
                    checked={data.roles == "Buyer With Limit"}
                    className="checkbox__input"
                  />
                  <span className="checkbox__box"></span>
                  <span
        ...
        <button
          ...
          onClick={(e: any) => setEditUserData(false)}
          className="btn btn--rounded btn--yellow btn-submit"
        >
          Cancel
        </button>
