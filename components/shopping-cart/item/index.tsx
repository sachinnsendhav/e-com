      ...
      <div style={{ display: "flex",width:"100%",position: "relative" }}>
        ...
        <div style={{ alignItems: "right", marginTop: "2rem",position: "absolute",right: "0" }}>
          ...
          <div style={{ marginTop: "1rem" }}>
            <div style={{ marginLeft: "29rem", fontSize:"1rem" , fontWeight:"500" ,  color:"#4c4c4c", padding: "0.7rem", background: "rgba(0, 0, 0, 0.05)" }}> Item Total: {CURRENCY_SYMBOLE}{(price / 100).toFixed(2)}</div>
          </div>
          <div>
            <div
              style={{
